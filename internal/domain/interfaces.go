...
// SkinRepository - интерфейс репозитория скинов
...
// MarketClient - интерфейс для получения цен
...
type CacheStorage interface {
	...
	// Sorted Set operations (для аналитики, трендинга)
...
// ZMember - член sorted set с его score
type ZMember struct {
	Member string
	Score  float64
}
